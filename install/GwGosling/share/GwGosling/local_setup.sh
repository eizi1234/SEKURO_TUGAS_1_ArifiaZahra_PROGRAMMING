...
: ${AMENT_CURRENT_PREFIX:="/root/GHitzeed/install/GwGosling"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/GwGosling/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/GwGosling/environment/path.sh"
